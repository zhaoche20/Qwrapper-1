 ...
 */
public class Wrapper_gjsaircx001 implements QunarCrawler{
    private static final String CODEBASE = "gjsaircx001";
    ...
    public String getHtml(FlightSearchParam flightSearchParam) {
        ...
        String url = "http://amadeus.corp.qunar.com/RoundTrip?dep=" + dep + "&arr=" + arr + "&depDate=" + depDate + "&arrDate=" + retDate + "&CarrierId=CX";
        try {
